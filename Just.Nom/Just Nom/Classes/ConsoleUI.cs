...
{
    /// <summary>
    ///  this console class provides the user interface for interacting
    ///  it initalizes and displays the menu items, takes care of the users inputs and orders
    ///  allows the addition of pizza and burgers.
    ///  this class also allows for utility methids for getting valid input ranges and utilies try catch to hande erros during the menu display process
    /// </summary>
