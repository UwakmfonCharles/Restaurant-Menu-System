...
{
    /// <summary>
    /// this class handles the creation of customers orders, allowing the user to speicify what they want and if they want delivery or not
    /// it allows customers to select food items from the menu and add it to the order, and then writes the otder to a file
    /// </summary>
