...
namespace Just_Nom.Classes
{
    ...
    /// <summary>
    /// the order class represents an order that contains a list of fooditem objects and is associated with customer class and an address
    /// it provides methods to add and remove food items
    /// to calculate the total prce and write the orders in a file
    /// the class also includes methods to get the total price and generate a formatted string of order details, although the file-weiting functionality is not completely working.
    /// </summary>
